...
function Shortcut_commentary()
	if (expand('%:e')=="c" || expand('%:e')=="cpp" || expand('%:e')=="h" || expand('%:e')=="hpp" || expand('%')==".c" || expand('%')==".cpp" || expand('%:e')=="js" || expand('%:e')=="vert" || expand('%:e')=="frag")
	...
	elseif expand('%:e')=="sh" || expand('%')==".sh" || expand('%')=="Makefile" || expand('%')=="Dockerfile"
		nnoremap <C-O> :s/\#\\|^/\#/<CR>:noh<CR>
		inoremap <C-O> <esc>:s/\#\\|^/\#/<CR>:noh<CR>i
		vnoremap <C-O> :s/\#\\|^/\#/<CR>:noh<CR>v
		nnoremap <C-P> :s/\#\\|^//<CR>:noh<CR>
